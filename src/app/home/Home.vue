  ...
  <div>
    ...
    <v-container grid-list-xl class="mt-5 mb-5">
      <v-layout row justify-center wrap>
        <v-flex xs12 sm8 md4>
          <div>
            <v-icon size="15rem">fa fa-cubes</v-icon>
          </div>
        </v-flex>

        <v-flex xs12 sm8 md4>
          <div>
            <div class="headline">Sprint from Zero to App</div>
    ...
    <v-container grid-list-xl class="mt-5 mb-5">
      <v-layout row justify-center wrap>
        <v-flex xs12 sm8 md4>
          <div>
            <div class="headline">Fast and Consistent</div>
        ...
        <v-flex xs12 sm8 md4>
          <div>
            <v-icon size="15rem">av_timer</v-icon>
          </div>
        </v-flex>
      </v-layout>
    </v-container>
    ...
    <v-container grid-list-xl class="mt-5 mb-5">
      <v-layout row justify-center wrap>
        <v-flex xs12 sm8 md4>
          <div>
            <v-icon size="15rem">color_lens</v-icon>
          </div>
        </v-flex>

        <v-flex xs12 sm8 md4>
          <div>
            <div class="headline">Versatile</div>
