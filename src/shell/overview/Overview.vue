  ...
  <v-container class="shell-container" fluid>
    <v-layout column>
      ...
      <v-layout column class="mt-1">
        ...
        <div>
          05. Internationalization - Adapt applications and text to enable their usability in a
          particular cultural or linguistic market.
        </div>
        <div>
          06. Data Visualization - Produce dynamic, interactive data visualizations in applications.
        </div>
        <div>07. Authorization - Provide a user identity to applications.</div>
        <div>08. Payment - Process payments from users for applications.</div>
        <div>09. Messages - Communicate or deliver messages to users for applications.</div>
