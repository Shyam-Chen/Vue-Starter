...
import { ref } from 'vue';
import { XBreadcrumb, XButton, XChip } from '@x/ui';
...
<template>
  ...
  <div class="my-8">
    <div class="text-3xl font-bold my-4 pt-6">Template</div>
  ...
  <div class="my-8">
    ...
    <div class="my-4">
      <div class="text-2xl font-semibold my-4 pt-2">Controlled</div>
