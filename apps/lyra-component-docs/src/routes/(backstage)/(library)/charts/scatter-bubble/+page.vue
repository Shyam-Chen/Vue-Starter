...
const bubbleChartOption = computed<EChartsOption>(() => {
  const data = [
    [
...
<template>
  <XBreadcrumb :items="[{ text: 'Library' }, { text: 'Charts' }, { text: 'Scatter & Bubble' }]" />

  <h1 class="text-4xl font-extrabold my-4">Scatter & Bubble</h1>
