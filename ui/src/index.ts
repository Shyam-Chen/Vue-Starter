...
export { default as XChatBox } from './components/chat-box/ChatBox.vue';
...
export { default as XMeterGroup } from './components/meter-group/MeterGroup.vue';
...
export { default as XWatermark } from './components/watermark/Watermark.vue';
