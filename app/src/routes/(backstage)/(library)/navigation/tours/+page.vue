...
const steps = computed<ComponentProps<typeof XTour>['steps']>(() => [
  {
    title: `What is Vue?`,
    content: `Vue (pronounced /vjuː/, like view) is a JavaScript framework for building user interfaces.`,
    target: el1,
  },
  {
...
<template>
  ...
  <div
    ref="el2"
    class="flex items-center justify-center w-full h-48 bg-gray-300 rounded-sm dark:bg-gray-700 animate-pulse"
  >
