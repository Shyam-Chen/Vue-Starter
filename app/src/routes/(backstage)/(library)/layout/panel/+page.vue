...
<template>
  <XBreadcrumb :items="[{ text: 'Library' }, { text: 'Layout' }, { text: 'Panel' }]" />

  <h1 class="text-4xl font-extrabold my-4">Panel</h1>
  ...
  <div class="my-8">
    <div class="text-3xl font-bold mb-4 pt-6">Initial Status</div>
